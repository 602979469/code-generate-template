...
- 输出 17 个文件：DO、Mapper、Mapper.xml、Model、QueryParam、Repository、RepositoryImpl、仓储 Assembler（assembler 包）、DomainService、DomainServiceTest、Manager（app.biz）、Controller（web/controller，走 ${toolPrefix}Template）、4 个 DTO（web/param、web/result）、web Assembler。
